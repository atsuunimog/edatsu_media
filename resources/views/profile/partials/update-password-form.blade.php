    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="current_password" name="current_password" type="password"
             class="mt-1 block w-5 shadow-none mb-2 border fs-9 w-50 form-control" autocomplete="current-password" />
        ...
        <div>
            ...
            class="mt-1 block w-5 shadow-none mb-2 border fs-9 w-50 form-control" autocomplete="new-password" />
