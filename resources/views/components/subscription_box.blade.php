...
<div id="mc_embed_shell" class="bg-white border rounded" >
<div id="mc_embed_signup">
    <form action="https://edatsu.us18.list-manage.com/subscribe/post?u=ce5edb3afeca14d1d47a046bf&amp;id=873d67a43e&amp;f_id=00cf9ce6f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
        <div id="mc_embed_signup_scroll" >
            <h2 class="fw-bold p-0">Subscribe</h2>
            ...
            <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="w-100 d-block btn btn-dark fw-bold py-3 m-0 mt-3 border-0" value="Subscribe">
            </div>
        </div>
    </form>
</div>
