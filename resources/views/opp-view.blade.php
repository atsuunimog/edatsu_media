        ...
        <div class="col-sm-12">
            <ul class='list-inline m-0 py-3'>
                ...
                <li class="list-inline-item"><a href='{{url('/')}}' 
                    class='text-decoration-none bprder-0 btn btn-green border-0 px-4 fs-9 text-light py-2 shadow-sm mb-2
                    {{(url()->current() == $protocol.$_SERVER['HTTP_HOST'])? 'bg-green' : 'bg-gray'}}'>Go Back</a>
                </li>
    
                <li class="list-inline-item "><a href='{{url('events')}}' 
                    class='text-decoration-none bprder-0 btn  btn-gray border-0 px-4 py-2 fs-9 shadow-sm mb-2
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <ul class="share-icons">
            <li>
                <a href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}&quote={{$opp_posts->title}}" 
                    target="_blank">
            ...
            <li>
                <a href="whatsapp://send?text={{$opp_posts->title}}link:{{url()->current()}}" target="_blank">
            ...
            <li>
                <a href="https://www.instagram.com/share?url={{url()->current()}}&utm_campaign=my-campaign&utm_content={{$opp_posts->title}}
                "target="_blank">
            ...
            <li><a href="https://www.linkedin.com/sharing/share-offsite/?url={{url()->current()}}&title={{$opp_posts->title}}" target="_blank">
            ...
            <li>
                <a href="https://twitter.com/share?url={{url()->current()}}&amp;text={{$opp_posts->title}}" target="_blank">
